...
// when Manager Agent performs any sales or inventory write.
// Calls fetchSales() immediately so the table reflects the change
...
export default function Sales() {
  ...
  useEffect(() => {
    ...
    const poll = setInterval(fetchSales, 10000)
  ...
  const doDelete = async () => {
    ...
    try {
      ...
      addToast(`Sale record for "${product}" deleted.`, 'info')
      fetchSales()
